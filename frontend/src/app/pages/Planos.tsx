    ...
    <div className="bg-complexo-dark pt-32 pb-24 lg:pt-40">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          {/* Billing toggle */}
          <div className="mt-8 inline-flex items-center gap-1 rounded-full border border-white/10 bg-complexo-surface p-1">
            <button
        ...
        <Reveal className="mt-20">
          ...
          <div className="mt-8 overflow-x-auto rounded-2xl border border-white/10">
            <table className="w-full min-w-[640px] border-collapse text-sm">
              <thead>
                <tr className="border-b border-white/10 bg-complexo-surface">
        ...
        <Reveal className="mt-14 flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-complexo-surface p-8 text-center">
          ...
          <MagneticButton
            as={Link}
            to="/contato"
            className="inline-flex items-center gap-2 rounded-full border border-white/15 px-7 py-3.5 font-semibold transition-colors hover:bg-white/5"
          >
